    ...
    try:
        ...
        try:
            if signal_type == "entry":
                ...
                logger.info(f"🎯 Trail engine: start tracking for {data.get('symbol')} {data.get('direction')}")
                ...
                logger.info(f"🎯 Trail engine: position closed for {data.get('symbol')} {data.get('direction')}")
        except Exception as e:
